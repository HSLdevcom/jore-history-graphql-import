...
curl --list-only ftp://195.255.176.166/karttainfopoiminta_test/ --user ${USERNAME}:${PASSWORD} > /tmp/allfiles.txt
...
curl ftp://195.255.176.166/karttainfopoiminta_test/${LATEST_FILE} --user ${USERNAME}:${PASSWORD} --output /tmp/build/${LATEST_FILE}
