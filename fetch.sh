...
#curl --list-only ftp://195.255.176.166/jorehistory/ --user ${USERNAME}:${PASSWORD} > /tmp/allfiles.txt
#
...
#    exit 64
#fi
export LATEST_FILE=poiminta.zip

rm -rf /tmp/build/*

curl http://dev-kartat.hsldev.com/poiminta/karttainfopoiminta_201808212006.zip --output /tmp/build/${LATEST_FILE}
